...
app-composer-install:
	docker compose run --rm rr-bundle composer install
...
app-test:
	docker compose run --rm rr-bundle composer test

app-lint:
	docker compose run --rm rr-bundle composer cs-fix

app-rector:
	docker compose run --rm rr-bundle vendor/bin/rector process

app-rector-dry:
	docker compose run --rm rr-bundle vendor/bin/rector process  --dry-run

shell-php:
	docker compose exec rr-bundle bash
